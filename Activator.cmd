...
echo:
echo:                 Mau Aktifin Apa masbro? :
echo:
echo:             [1] Lisensi Windows Permanen
echo:             [2] Lisensi Office Permanen
echo:             [3] Lisensi Windows Sementara
echo:             [4] Office/Windows buat 180 hari
echo:             [5] Cek Masa Aktif Windows
echo:             [6] Troubleshoot
echo:             [7] Extra
echo:             [8] Butuh Bantuan?
echo:             [0] Keluar
echo:       ______________________________________________________________
echo:
call :_color2 %_White% "          " %_Green% "Pencet sesuai nomor ya masbro [1,2,3,4,5,6,7,8,0] :"
...
echo:       ______________________________________________________________
echo:
echo:             [1] Ganti Edisi Windowsmu
echo:             [2] Ekstrak $OEM$ Folder
echo:             [3] Activation Status [vbs]
echo:             [4] Download Genuine Windows / Office
echo:             [0] Balik ke menu
echo:       ______________________________________________________________
echo:
